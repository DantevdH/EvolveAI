...
gym_exercises["Unique ID"] = gym_exercises["Exercise Name"] + gym_exercises["Equipment"] + gym_exercises["Main Muscle"] 
...
gym_exercises_filtered = gym_exercises[["Exercise Name", "Force", "Instructions", "Equipment", "Main Muscle", "Secondary Muscles", "Difficulty"]]
