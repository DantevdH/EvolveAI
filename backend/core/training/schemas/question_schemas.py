...
class GeminiAthleteTypeClassification(BaseModel):
    ...
    primary_type: str = Field(..., description="Primary athlete type: 'strength', 'endurance', or 'sport_specific'")
...
class QuestionContentItem(BaseModel):
    ...
    order: int = Field(..., description="Display order for this question (1-based, lower numbers appear first)")
