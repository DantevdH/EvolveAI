...
def test_exercise_selection_beginner_difficulty(exercise_selector):
    ...
    print(f"✅ Beginner difficulty: Returned formatted string ({len(result)} characters)")
...
def test_exercise_selection_advanced_difficulty(exercise_selector):
    ...
    print(f"✅ Advanced difficulty: Returned formatted string ({len(result)} characters)")
...
def test_get_formatted_exercises_for_ai_returns_string(exercise_selector):
    ...
    print(f"✅ get_formatted_exercises_for_ai returns formatted string: {len(result)} characters")
...
def test_edge_case_empty_difficulty(exercise_selector):
    ...
    print(f"✅ Empty difficulty: handled gracefully, returned string ({len(result)} characters)")
...
def test_edge_case_invalid_difficulty(exercise_selector):
    ...
    print(f"✅ Invalid difficulty: handled gracefully, returned string ({len(result)} characters)")
...
def test_edge_case_no_exercises_found(exercise_selector):
    ...
    print(f"✅ No exercises found: handled gracefully, returned string ({len(result)} characters)")
...
def test_exercise_candidates_with_popularity_filter(exercise_selector):
    ...
    print(f"✅ Popularity filtered exercises: Returned formatted string ({len(result)} characters)")
...
def test_exercise_candidates_with_single_difficulty(exercise_selector):
    ...
    print(f"✅ Single difficulty: handled gracefully, returned string ({len(result)} chars)")
...
def test_exercise_candidates_with_very_small_max_exercises(exercise_selector):
    ...
    print(f"✅ Small max_exercises: handled gracefully, returned string ({len(result)} chars)")
...
def test_exercise_candidates_with_none_difficulty(exercise_selector):
    ...
    print(f"✅ None difficulty: handled gracefully, returned string ({len(result)} chars)")
...
def test_exercise_candidates_with_empty_string_difficulty(exercise_selector):
    ...
    print(f"✅ Empty string difficulty: handled gracefully, returned string ({len(result)} chars)")
...
def test_group_exercises_by_main_muscles(exercise_selector):
    ...
    mock_exercises = [
        {"id": "1", "name": "Squat", "main_muscles": ["Thighs", "Glutes"], "difficulty": "Intermediate"},
        {"id": "2", "name": "Push-up", "main_muscles": ["Chest", "Shoulders"], "difficulty": "Beginner"},
        {"id": "3", "name": "Deadlift", "main_muscles": ["Thighs", "Back"], "difficulty": "Advanced"},
        {"id": "4", "name": "Bench Press", "main_muscles": ["Chest"], "difficulty": "Intermediate"},
    ]
...
def test_format_exercises_for_ai(exercise_selector):
    ...
    mock_grouped_exercises = [
        {"id": "1", "name": "Push-up", "difficulty": "Beginner", "main_muscle_group": "Chest", "equipment": "Bodyweight"},
        {"id": "2", "name": "Bench Press", "difficulty": "Intermediate", "main_muscle_group": "Chest", "equipment": "Barbell"},
        {"id": "3", "name": "Squat", "difficulty": "Intermediate", "main_muscle_group": "Thighs", "equipment": "Barbell"}
    ]
    
    # Call the internal method
    formatted_string = exercise_selector._format_exercises_for_ai(mock_grouped_exercises)
...
def test_exercise_data_structure_requirements(exercise_selector):
    ...
    mock_exercises = [
        {"id": "1", "name": "Squat", "main_muscles": ["Thighs"], "difficulty": "Intermediate"},
    ...
    try:
        ...
        print("✅ Exercise data structure requirements: handles missing fields gracefully")
    except Exception as e:
