#!/usr/bin/env python3
"""
Unit tests for TrainingCoach component.

This module tests the TrainingCoach in isolation with mocked dependencies
to ensure comprehensive coverage of training coaching logic, training generation,
and RAG integration.
"""
...
class TestTrainingCoach:
    ...
    def mock_base_agent(self):
        ...
        mock_agent.agent_name = "training Coach"
        mock_agent.agent_description = "Expert in strength training, muscle building, weight loss routines, and training planning"
        return mock_agent
    ...
    def mock_prompt_generator(self):
        ...
        # This is now handled internally by the TrainingCoach
        return None
    ...
    def mock_training_coach(
        ...
        """Create TrainingCoach with mocked dependencies."""
        with patch(
            ...
            "core.training.training_coach.ExerciseValidator",
            ...
            # Mock the validate_training_plan method
            coach.exercise_validator.validate_training_plan = Mock(
    ...
    def test_training_coach_initialization(
        ...
        """Test TrainingCoach initialization."""
        with patch(
            "core.training.training_coach.BaseAgent.__init__",
            return_value=None,
        ) as mock_base_init, patch(
    ...
    async def test_training_coach_topic_filtering(self, mock_training_coach):
        ...
        assert (
            mock_training_coach.topic == "training"
    ...
    async def test_process_request_success(self, mock_training_coach):
        ...
        mock_training_coach.search_knowledge_base.return_value = [
            {
                "chunk_text": "Sample training content for muscle building",
                "document_title": "training Guide",
            }
        ]
        ...
        response = mock_training_coach.process_training_request(user_request)
    ...
    async def test_process_request_error_handling(self, mock_training_coach):
        ...
        mock_training_coach.search_knowledge_base.side_effect = Exception(
            "Database error"
        )
    ...
    def test_generate_training_plan_success(
        self, mock_training_coach, sample_user_profile
    ):
    ...
    async def test_validate_training_plan(self, mock_training_coach):
        ...
        mock_training_coach.exercise_validator.validate_training_plan.assert_called_once_with(
            training_plan
        )
...
class TestTrainingCoachEdgeCases:
    """Test edge cases and error scenarios for TrainingCoach."""

    @pytest.fixture
    def mock_training_coach_edge_cases(self):
        """Create TrainingCoach for edge case testing."""
        with patch(
            "core.training.training_coach.BaseAgent.__init__",
            return_value=None,
        ), patch("core.training.training_coach.RAGTool"), patch(
            "core.training.training_coach.ExerciseSelector"
        ), patch(
            "core.training.training_coach.ExerciseValidator"
        ):
    ...
    def test_process_request_extremely_long_request(
        ...
        long_request = "I want a training plan " * 1000
