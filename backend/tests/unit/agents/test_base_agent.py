...
class ConcreteTestAgent(BaseAgent):
    ...
    def __init__(self, agent_name: str = "Test Agent", agent_description: str = "Test Description", topic: str = "test"):
...
class TestBaseAgent:
    ...
    def mock_clients(self):
        ...
        with patch('core.base.base_agent.openai.OpenAI') as mock_openai, \
             patch('core.base.base_agent.create_client') as mock_supabase:
    ...
    def test_search_knowledge_base_success(self, mock_environment, mock_clients):
        ...
        mock_docs_response.data = [{'id': 'doc1', 'title': 'Test Doc', 'content': 'Test content', 'topic': 'test', 'keywords': ['test']}]
        ...
        mock_supabase_client.table.return_value.select.return_value.eq.return_value.execute.return_value = mock_docs_response
        mock_supabase_client.table.return_value.select.return_value.in_.return_value.execute.return_value = mock_embeddings_response
    ...
    def test_search_knowledge_base_embedding_failure(self, mock_environment, mock_clients):
    ...
    def test_cosine_similarity_fallback_calculation(self, mock_environment, mock_clients):
        ...
        with patch('sklearn.metrics.pairwise.cosine_similarity', side_effect=ImportError):
            similarity = agent._cosine_similarity(vec1, vec2)
...
class TestBaseAgentEdgeCases:
    ...
    def test_search_knowledge_base_invalid_embedding_json(self, mock_environment, mock_clients):
    ...
    def test_search_knowledge_base_empty_embedding_vector(self, mock_environment, mock_clients):
    ...
    def test_search_knowledge_base_zero_similarity_scores(self, mock_environment, mock_clients):
    ...
    def test_cosine_similarity_exception_handling(self, mock_environment, mock_clients):
        ...
        with patch('sklearn.metrics.pairwise.cosine_similarity', side_effect=Exception("Unexpected error")):
            similarity = agent._cosine_similarity(vec1, vec2)
