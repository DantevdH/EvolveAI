...
class TestFitnessCoach:
    ...
    def test_fitness_coach_initialization(self):
        ...
        with patch('core.agents.specialists.fitness_coach.BaseAgent.__init__') as mock_base_init:
            with patch('core.agents.specialists.fitness_coach.RAGTool') as mock_rag_tool:
                with patch('core.agents.specialists.fitness_coach.WorkoutPromptGenerator') as mock_prompt_gen:
