...
class TestDatabaseService:
    ...
    def mock_supabase_client(self):
        ...
        with patch(
            "core.training.helpers.database_service.create_client"
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_success(
        self, database_service, mock_supabase_client, sample_training_plan_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_existing_plan(
        self, database_service, mock_supabase_client, sample_training_plan_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_with_jwt_token(
        self, database_service, mock_supabase_client, sample_training_plan_data
    ):
        """Test training plan saving with JWT token authentication."""
        # Mock the service role key to be None to force JWT token path
        with patch(
            "core.training.helpers.database_service.settings.SUPABASE_SERVICE_ROLE_KEY",
            None,
        ):
            # Mock no existing plan
            mock_existing_response = Mock()
            ...
            result = await database_service.save_training_plan(
                1, sample_training_plan_data, "test-jwt-token"
            )
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_duplicate_key_violation(
        self, database_service, mock_supabase_client, sample_training_plan_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_foreign_key_violation(
        self, database_service, mock_supabase_client, sample_training_plan_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_generic_error(
        self, database_service, mock_supabase_client, sample_training_plan_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_pydantic_model(
        self, database_service, mock_supabase_client, sample_training_plan_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_dict_method(
        self, database_service, mock_supabase_client, sample_training_plan_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_rest_day_only(
        self, database_service, mock_supabase_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_training_plan_success(
        self, database_service, mock_supabase_client
    ):
        ...
        mock_plan_response.data = [
            {"id": 1, "title": "Test Plan", "user_profile_id": 1}
        ]
        ...
        mock_exercise_response.data = [
            {"id": 4, "daily_training_id": 3, "exercise_id": 1}
        ]
    ...
    @pytest.mark.asyncio
    async def test_get_training_plan_database_error(
        self, database_service, mock_supabase_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_training_plan_with_rest_days(
        self, database_service, mock_supabase_client
    ):
        ...
        mock_exercise_response = Mock()
        mock_exercise_response.data = [
            {"id": 5, "daily_training_id": 3, "exercise_id": 1}
        ]
...
class TestDatabaseServiceEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_weekly_schedule_failure(
        self, database_service, mock_supabase_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_daily_training_failure(
        self, database_service, mock_supabase_client
    ):
            ...
            "weekly_schedules": [
                {
                    "week_number": 1,
                    "daily_trainings": [
                        {"day_of_week": "Monday", "is_rest_day": False, "exercises": []}
                    ],
                }
            ],
        }
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_exercise_failure(
        self, database_service, mock_supabase_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_save_training_plan_missing_exercise_data(
        self, database_service, mock_supabase_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_training_plan_empty_weekly_schedules(
        self, database_service, mock_supabase_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_training_plan_empty_daily_trainings(
        self, database_service, mock_supabase_client
    ):
