...
class TestScripts:
    ...
    def test_populate_script_import(self):
        ...
        try:
            ...
            assert (
                VectorDBPopulator is not None
            ), "VectorDBPopulator should be importable"
    ...
    def test_populate_script_no_sample_data(self):
        ...
        try:
            ...
            deprecated_methods = ["create_sample_documents", "run_sample_population"]

            for method in deprecated_methods:
                assert not hasattr(
                    VectorDBPopulator, method
