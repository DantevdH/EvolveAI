  ...
  static async generateTrainingPlan(
    ...
    try {
      ...
      if (result.status === 'success') {
        console.log('✅ Training plan generated by backend');
        ...
        if (trainingPlanResult.success && trainingPlanResult.data) {
          console.log('✅ Training plan fetched from database');
          return {
            success: true,
            data: trainingPlanResult.data,
          };
        } else {
          console.error('❌ Failed to fetch generated training plan from database');
          return {
            success: false,
